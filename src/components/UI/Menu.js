                  ...
                  <ul className="standard_dropdown main_nav_dropdown">
                    ...
                    <li className="hassubs">
                      ...
                      <ul>
                        <li>
                          <a href="/">
                            Lenovo<i className="fa fa-chevron-down"></i>
                          </a>
                          <ul>
                            <li>
                              <a href="/">
                                Lenovo 1<i className="fa fa-chevron-down"></i>
                              </a>
                            </li>
                            <li>
                              <a href="/">
                                Lenovo 3<i className="fa fa-chevron-down"></i>
                              </a>
                            </li>
                            <li>
                              <a href="/">
                                Lenovo 2<i className="fa fa-chevron-down"></i>
                              </a>
                            </li>
                          </ul>
                        </li>
                        <li>
                          <a href="/">
                            DELL<i className="fa fa-chevron-down"></i>
                          </a>
                        </li>
                        <li>
                          <a href="/">
                            APPLE<i className="fa fa-chevron-down"></i>
                          </a>
                        </li>
                        <li>
                          <a href="/">
                            HP<i className="fa fa-chevron-down"></i>
                          </a>
                        </li>
                      </ul>
                    </li>
                    <li className="hassubs">
                      <a href="/">
                        Featured Brands<i className="fa fa-chevron-down"></i>
                      </a>
                      <ul>
                        <li>
                          <a href="/">
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="/">
                                Mobiles<i className="fa fa-chevron-down"></i>
                              </a>
                            </li>
                            <li>
                              <a href="/">
                                Ipads<i className="fa fa-chevron-down"></i>
                              </a>
                            </li>
                          </ul>
                        </li>
                        <li>
                          <a href="/">
                            Samsung<i className="fa fa-chevron-down"></i>
                          </a>
                        </li>
                        <li>
                          <a href="/">
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="blog_single.html">
                            Blog Post<i className="fa fa-chevron-down"></i>
                          </a>
                        </li>
                        <li>
                          <a href="regular.html">
                            Regular Post<i className="fa fa-chevron-down"></i>
                          </a>
                        </li>
                        <li>
                          <a href="cart.html">
                            Cart<i className="fa fa-chevron-down"></i>
                          </a>
                        </li>
                        <li>
                          <a href="contact.html">
              ...
              <div className="page_menu_content">
                ...
                <div className="menu_contact">
                  ...
                  <div className="menu_contact_item">
                    ...
                    <a href="mailto:v.sathyanantham@gmail.com">
